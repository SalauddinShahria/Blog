                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="delete-option text-center">
                          <ul>
                            <li><a href="post.php?do=Delete&delete=<?php echo $post_id; ?>" id="toasttest" class="btn btn-danger">Delete</a></li>
                        ...
                        <div class="card-body" style="display: block;">
                          <div class="row">
                            ...
                            <div class="col-lg-6">                                
                                ...
                                <div class="form-group">
                                  <input type="submit" name="addPost" id="toasttest" class="btn btn-block btn-primary btn-flat" value="Publish Post">
                                </div>
                              </form>
                            </div>
                          </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-6">                                
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="submit" name="updatePost" id="toasttest" class="btn btn-block btn-primary btn-flat" value="Save Changes">
                                    </div>
                                  </form>
                                </div>
                              </div>
